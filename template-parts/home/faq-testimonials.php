...
<section class="betpro-testimonials-section py-24 bg-background">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <?php
            $testimonials = array(
                array('quote' => __('I had a smooth experience while creating my BetPro account. It was a fast process, and the agent gave me easy instructions. Professionally managed all of it, I could start using my account without any hassle.', 'betpro-account'), 'name' => __('Ahmed R.', 'betpro-account'), 'location' => __('Lahore', 'betpro-account'), 'headline' => __('Credentials delivered on schedule', 'betpro-account'), 'avatar' => 'testimonial-1.png'),
                ...
                array('quote' => __('I was inexperienced with this platform, but the signup process was way too easy. It didn’t take long to create my BetPro account, and I could easily access it.', 'betpro-account'), 'name' => __('Usman T.', 'betpro-account'), 'location' => __('Islamabad', 'betpro-account'), 'headline' => __('Stress-free account creation', 'betpro-account'), 'avatar' => 'testimonial-3.png'),
                array('quote' => __('Good service and fast account creation. I liked how clearly everything was explained before setting up my BetPro account. It made the whole process stress-free.', 'betpro-account'), 'name' => __('Ali H.', 'betpro-account'), 'location' => __('Multan', 'betpro-account'), 'headline' => __('Reliable and smooth registration', 'betpro-account'), 'avatar' => 'testimonial-1.png'),
